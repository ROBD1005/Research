...
<<<<<<< HEAD
  filter(Date >= "2022-07-27",
         Date <= "2022-07-28") %>% 
=======
  filter(Date >= "2022-07-24",
         Date <= "2022-07-26") %>% 
>>>>>>> 3c9821bea97f6391d471c1fd5f68c0f24c2cebdb
    group_by(Tank_ID) %>% 
  na.omit() %>% 
  left_join(metadata)
...
ggsave(plot = mesocosm.temp.plot, width = 10, height = 10, dpi = 300, filename = "mesocosm.temp.plotJuly25.png")
