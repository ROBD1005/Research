...
path.p<-"Data/Experiment_Data/Respiration_Data_Prelim" #the location of all your respirometry files
...
colnames(Photo.R) <- c("ID","Intercept", "umol.L.sec","Temp.C","PR")


#Load Sample meta info Info
Sample.Info <- read.csv(file="Data/Experiment_Data/Metadata/Weight_Volume_TrialRun_12_14_2021.csv", header=T) #read sample.info data

#load surface area data
#Add in the SA measurements fot the corals measured in ImageJ
SA<-read.csv('Data/Experiment_Data/Metadata/Weight_Volume_TrialRun_12_14_2021.csv')
