...
Data was downloaded from https://shorestations.ucsd.edu/ for the shore station of Newport Beach, CA there are other stations for the span of the California Coast availble to download on the website. Newport Beach Pier measurements collected by the City of Newport Beach Marine Operations Division.
...
newport.data <- read_csv("/Users/robertdellinger/Documents/Research/Data/Temperature_Data/scripps.newportbeach.sst.1925.2022.csv")

names(newport.data) <- c("year","month", "day", "NA1", "NA2", "SST", "NA3", "NA4")

newport.data <- newport.data[-c(1:29),] %>% 
  select(year, month, day, SST)

newport.data.clean <- newport.data %>% 
